...
class MujocoCAEnv(gym.Env):
    ...
    def __init__(
        ...
        self.model, self.data, self.init_dspec = self._initialize_simulation()
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None,
        ...
        # self.mujoco_renderer.con = mujoco.MjrContext(self.model, mujoco.mjtFontScale.mjFONTSCALE_150)
